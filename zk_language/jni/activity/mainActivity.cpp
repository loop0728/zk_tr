...
static ZKTextView* mTextview_titlePtr;
static ZKButton* mButton_sysPtr;
static ZKButton* mButton_AEPtr;
static ZKButton* mButton_FRPtr;
static ZKButton* mButton_KRPtr;
static ZKButton* mButton_JPPtr;
static ZKButton* mButton_USPtr;
static ZKButton* mButton_CNPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_Button_ES, onButtonClick_Button_ES,
    ID_MAIN_Button_sys, onButtonClick_Button_sys,
    ID_MAIN_Button_AE, onButtonClick_Button_AE,
    ID_MAIN_Button_FR, onButtonClick_Button_FR,
    ID_MAIN_Button_KR, onButtonClick_Button_KR,
    ID_MAIN_Button_JP, onButtonClick_Button_JP,
    ID_MAIN_Button_US, onButtonClick_Button_US,
    ID_MAIN_Button_CN, onButtonClick_Button_CN,
};
/***************/
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mButton_ESPtr = (ZKButton*)findControlByID(ID_MAIN_Button_ES);
    ...
    mTextview_titlePtr = (ZKTextView*)findControlByID(ID_MAIN_Textview_title);
    mButton_sysPtr = (ZKButton*)findControlByID(ID_MAIN_Button_sys);
    mButton_AEPtr = (ZKButton*)findControlByID(ID_MAIN_Button_AE);
    mButton_FRPtr = (ZKButton*)findControlByID(ID_MAIN_Button_FR);
    mButton_KRPtr = (ZKButton*)findControlByID(ID_MAIN_Button_KR);
    mButton_JPPtr = (ZKButton*)findControlByID(ID_MAIN_Button_JP);
    mButton_USPtr = (ZKButton*)findControlByID(ID_MAIN_Button_US);
    mButton_CNPtr = (ZKButton*)findControlByID(ID_MAIN_Button_CN);
	mActivityPtr = this;
	onUI_init();
